...
const buildDB = async () => {
  ...
  await pool.query('DROP TABLE IF EXISTS related');
  ...
  // Create skus table
  await pool.query('CREATE TABLE IF NOT EXISTS skus (sku_id INTEGER NULL DEFAULT NULL, style_id INTEGER NULL DEFAULT NULL, size VARCHAR(15) NULL DEFAULT NULL, quantity INTEGER NULL DEFAULT NULL, PRIMARY KEY (sku_id))');

  // Create photos table
  await pool.query('CREATE TABLE IF NOT EXISTS photos (photo_id INTEGER NULL DEFAULT NULL, style_id INTEGER NULL DEFAULT NULL, url VARCHAR NULL DEFAULT NULL, thumbnail_url VARCHAR NULL DEFAULT NULL, PRIMARY KEY (photo_id))');

  // Create photos table
  await pool.query('CREATE TABLE IF NOT EXISTS features (feature_id INTEGER NULL DEFAULT NULL, product_id INTEGER NULL DEFAULT NULL, feature VARCHAR(25) NULL DEFAULT NULL, value VARCHAR(40) NULL DEFAULT NULL, PRIMARY KEY (feature_id))');
